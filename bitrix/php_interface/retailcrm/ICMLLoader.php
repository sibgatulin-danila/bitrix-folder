<?
                        //ob_start();
                        //print_r($products);
                        //$result = 'test '.  date('H:i:s');
                        //ob_clean();
                        //ob_end_clean();                        
                        //file_put_contents($_SERVER['DOCUMENT_ROOT'].'/local/includes/otvet.txt',$result);       
                        ...
                        while ($product = $dbResProducts->GetNext()) {
                            if($product['PROPERTY_PHOTOGALLERY_VALUE']){
                                ...
                                if($arrElement = $rrsElement->GetNext()){                                        
                                        ...
                                        $product['DETAIL_PICTURE'] = 'http://poisondrop.ru'.CFile::GetPath($arrElement['PROPERTY_REAL_PICTURE_VALUE']);
                                        $product['PICTURE'] = 'http://poisondrop.ru'.CFile::GetPath($arrElement['PROPERTY_REAL_PICTURE_VALUE']);
                                }                                    
                            }
...
$offer['_PROP_manufacturer'] = $product['PROPERTY_DESIGNER_NAME'];
                                ...
                                if (!$existOffer) {
                                    ...
                                    $product['_PROP_manufacturer'] = $product['PROPERTY_DESIGNER_NAME'];
                                    $product['COMPOSITION'] = $product['PROPERTY_COMPOSITION_VALUE'];
                                    $product['CML2_ARTICLE'] = $product['PROPERTY_CML2_ARTICLE_VALUE'];
