...
abstract class CAllUser extends CDBResult
{
	...
	public function ChangePassword($LOGIN, $CHECKWORD, $PASSWORD, $CONFIRM_PASSWORD, $SITE_ID=false, $captcha_word = "", $captcha_sid = 0, $authActions = false, $phoneNumber = "")
	{
		/** @global CMain $APPLICATION */
		global $DB, $APPLICATION;
...
if($res["CHECKWORD"] == '' || $res["CHECKWORD"] != $arParams["CHECKWORD"])
	...
	public function Update($ID, $arFields, $authActions = false)
	{
		/** @global CUserTypeManager $USER_FIELD_MANAGER */
