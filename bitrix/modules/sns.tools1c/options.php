...
$arTabs = array(
   ...
   array(
      'DIV' => 'edit40',
      'TAB' => GetMessage('sns.tools1c_edit40'),
      'ICON' => '',
      'TITLE' => GetMessage('sns.tools1c_edit40'),
      'SORT' => '40'    
   )            
...
$arGroups = array(
   ...
   'OPTION_60' => array('TITLE' => GetMessage('sns.tools1c_OPTION_60'), 'TAB' => 3),        
);
...
$arOptions = array( 
   ...
   'NOT_CHANGE_CANCEL_ORDER' => array(
      'GROUP' => 'OPTION_60',
      'TITLE' => GetMessage('sns.tools1c_NOT_CHANGE_CANCEL_ORDER_TITLE'),
      'TYPE' => 'CHECKBOX',
      'REFRESH' => 'N',
      'SORT' => '10',
      'NOTES' => GetMessage('sns.tools1c_NOT_CHANGE_CANCEL_ORDER_DESCR'),         
   ),      
