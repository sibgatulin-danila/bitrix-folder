...
$MESS["sns.tools1c_edit40"] = "Заказы магазина";     
...
$MESS["sns.tools1c_OPTION_60"] = "Заказы магазина из 1С"; 
...
$MESS["sns.tools1c_NOT_CHANGE_CANCEL_ORDER_TITLE"] = "Игнорировать отмену из 1С"; 
$MESS["sns.tools1c_NOT_CHANGE_CANCEL_ORDER_DESCR"] = "При обмене с 1С игнорировать значения отмены пришедшие в файле обмена если заказ был уже отменен в битриксе";
