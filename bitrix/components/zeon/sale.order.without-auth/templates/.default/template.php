      ...
      include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/confirm.php");
		...
		<div class="b-paysystems" style="margin-top:20px;" id="step2">			
		  <? include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/paysystem.php"); ?>
                  <br>
		  <div align="center">
		  <input type="button" class="site_button site_button-green" name="submitbutton" id="submitButtonOrder" value="Отправить заказ" onclick="yaCounter21794221.reachGoal('PAY_ORDER'); return true;">
		  </div>
        	</div>
...
<div class="right_holder">
 <?$APPLICATION->IncludeComponent("zeon:sale.basket.basket", "order_basket", Array(
...
<script>
	...
	document.write('<img src="http://mixmarket.biz/uni/tev.php?id=1294942042&r='+escape(document.referrer)+'&t='+(new Date()).getTime()+'&a1='+univar1+'&a2='+univar2+'" width="1" height="1"/>');
</script>
