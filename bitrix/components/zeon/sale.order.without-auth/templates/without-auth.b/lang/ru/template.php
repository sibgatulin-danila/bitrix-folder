...
$MESS ['SOA_TEMPL_ORDER_SUC'] = "Спасибо!<br>Ваш заказ <span style='color:#ff216c'>№#ORDER_ID#</span> успешно создан.<br>Мы скоро свяжемся с Вами";
$MESS ['SOA_TEMPL_ORDER_SUC1'] = "Вы можете следить за выполнением своего заказа в <a href=\"#LINK#\">Персональном разделе сайта</a>. Обратите внимание, что для входа в этот раздел вам необходимо будет ввести логин и пароль пользователя сайта.<br><br>Приходите еще!";
