...
<?
 ...
 while ($product = $rsContentOrder->Fetch()):
     ...
     $thumb = CPoisonUtils::getFirstThumb($productID);
     ...
     $arFloktoryItemsNew[]='{ id: '.$productID.', qnt: '.$product['QUANTITY'].', price: '.$product['PRICE'].' }';
...
<?
$this->SetViewTarget("fb_orderscript");
?>
<script>
 var fb_param = {};
fb_param.pixel_id = '6010863261301';
fb_param.value = '0.00';
...
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/offsite_event.php?id=6010863261301&amp;value=0&amp;currency=RUB" /></noscript
<?
$this->EndViewTarget("fb_orderscript"); 
?>                                              
...
<?//$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH.'/include_areas/sale_breadcrumb.php',array('STEP'=>'PAY'));?>
	...
	<div class="color_dark-green" style="font-size:18px;">
	...
	<div style="background:#eeebe4;border-radius:4px;">
	  <div style="padding:20px;">
	    ...
	    тегами <span class="color_dark-green">#poisondropru</span> и <span class="color_dark-green">@poisondropru</span>

	  </div>
	</div>
	<?//=GetMessage("SOA_TEMPL_ORDER_SUC1", Array("#LINK#" => $arParams["PATH_TO_PERSONAL"])) ?>
	<br>
	 <div class="color_dark-green">До скорой встречи!</div>
	<?
